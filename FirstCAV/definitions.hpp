...
class kndr_MapControl {
    ...
    sizeEx = 0.075;
    fontLabel = "tt2020base_vn_bold";
    sizeExLabel = 0.075;
    fontGrid = "tt2020base_vn_bold";
    sizeExGrid = 0.02;
    fontUnits = "tt2020base_vn_bold";
    sizeExUnits = 0.075;
    fontNames = "tt2020base_vn_bold";
    sizeExNames = 0.075;
    fontInfo = "tt2020base_vn_bold";
    sizeExInfo = 0.075;
    fontLevel = "tt2020base_vn_bold";
    sizeExLevel = 0.02;
